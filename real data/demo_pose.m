...
for i=1:iter_epoch
    ...
    while norm(INITTRANS)<5
        INITTRANS=[40*rand-20;40*rand-20;40*rand-20];
    end
    save(['temp_data/case',num2str(case_index),'iter',num2str(i)], 'Point_3d_D', 'Point_2d_D_AP', 'Point_2d_D_LAT', 'r1', 'INITTRANS')
%     r1=[0;0;0];
%     INITTRANS=[0;0;0];
...
%     save(['every_epoch_result/epoch',num2str(i),'_',num2str(case_index),'_result'])
    ...
    tre3d(i) = mean(sqrt(sum(Point_3d_D_AP-Point_3d_D_R_AP_recover).^2));
    close all;
end
...
excel_all_refine=[error_r_refine_mean,error_t_refine_mean,tre_2d_refine,tre_3d,time_every_mean+time_every_refine_mean];
save(['exp_result/result_case',num2str(case_index)])
end

excel_result=[];
for case_index=1:10
   load(['exp_result/result_case',num2str(case_index)],'excel_all_refine')
   excel_result=[excel_result;excel_all_refine];
end
save('exp_result/excel_result','excel_result');
% rmdir('/home/science/code/matlab/miccai2020/shiyan_real/Our/temp_data', 's')
copyfile('temp_data', '/home/science/code/matlab/miccai2020/shiyan_real/Our/temp_data')
% rmdir('/home/science/code/matlab/miccai2020/shiyan_real/GMM/temp_data', 's')
copyfile('temp_data', '/home/science/code/matlab/miccai2020/shiyan_real/GMM/temp_data')
% rmdir('/home/science/code/matlab/miccai2020/shiyan_real/SOFT/temp_data', 's')
copyfile('temp_data', '/home/science/code/matlab/miccai2020/shiyan_real/SOFT/temp_data')
% rmdir('/home/science/code/matlab/miccai2020/shiyan_real/TIP/temp_data', 's')
copyfile('temp_data', '/home/science/code/matlab/miccai2020/shiyan_real/TIP/temp_data')
%  rmdir('/home/science/code/matlab/miccai2020/shiyan_real/goapc/temp_data', 's')
copyfile('temp_data', '/home/science/code/matlab/miccai2020/shiyan_real/goapc/temp_data')
%  rmdir('/home/science/code/matlab/miccai2020/shiyan_real/RANSAC/temp_data', 's')
copyfile('temp_data', '/home/science/code/matlab/miccai2020/shiyan_real/RANSAC/temp_data')
%  rmdir('/home/science/code/matlab/miccai2020/shiyan_real/TIP_D/temp_data', 's')
copyfile('temp_data', '/home/science/code/matlab/miccai2020/shiyan_real/TIP_D/temp_data')
cd ..
cd  GMM
demo_pose
cd ..
